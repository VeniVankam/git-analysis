...
import static com.scout24.githubanalysis.util.CookieUtils.*;

@Component
public class AuthorizationCookieRepository implements AuthorizationRequestRepository<OAuth2AuthorizationRequest> {
